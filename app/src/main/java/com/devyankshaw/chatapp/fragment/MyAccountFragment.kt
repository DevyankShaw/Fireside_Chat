package com.devyankshaw.chatapp.fragment
...
import com.devyankshaw.chatapp.SignInActivity
...
class MyAccountFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        view.apply {
            this.imageView_profile_picture.setOnClickListener {
           ...
           this.btn_sign_out.setOnClickListener {
                AuthUI.getInstance()
